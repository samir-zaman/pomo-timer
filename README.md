...
* **Dynamic heatmap visualization** using Cal-Heatmap, where index values automatically scale based on each user’s logged work time.

## 🛠 Tech Stack
* **Frontend:** React, Vite, React Router
* **Backend:** Firebase (Authentication & Realtime Database)
* **Visuals:** Cal-Heatmap, HTML / CSS / JavaScript
